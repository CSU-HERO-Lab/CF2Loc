...
RELEASE_CASES = (
    ...
    (
        ...
        "configs/PoseLocalRefiner_S3D_Dense.yaml",
    ...
    (
        ...
        PoseLocalRefinerLightning,
        "configs/PoseLocalRefiner_SemRayLoc_SemanticOneHot_Dense.yaml",
    ...
    (
        "zind_no_sem_refiner",
        PoseLocalRefinerLightning,
        "configs/PoseLocalRefiner_ZInD_MainDiffusion.yaml",
    ...
    (
        ...
        PoseLocalRefinerLightning,
        "configs/PoseLocalRefiner_ZInD_SemanticOneHot_Dense.yaml",
